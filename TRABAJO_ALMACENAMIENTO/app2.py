...
# Definir el directorio base para rutas absolutas
...
@st.cache_data
def load_data():
    csv_path = os.path.join(BASE_DIR, 'SS2324_laliga_players_cleaned.csv')
    xlsx_path = os.path.join(BASE_DIR, 'SS2324_laliga_players.xlsx')
...
# --- 3. BARRA LATERAL ---
img_path = os.path.join(BASE_DIR, "LaLiga.png")
